              ...
              >
                <div className="card-body">
                  ...
                  <p className="flex gap-2">
                    ...
                    <span>
                      {specialist.phoneNumber
                        ? <a href={`tel:${specialist.phoneNumber}`} className="hover:underline">{specialist.phoneNumber}</a>
                        : "Brak danych"}
                    </span>
                  </p>
                  <p className="flex gap-2">
                    ...
                    <span className="hover:underline"><a href={`mailto:${specialist.email}`}>{specialist.email}</a></span>
                  </p>
